...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-32 px-6 bg-white/[0.02]" ref={triggerRef}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
          {PROJECTS.map((project, idx) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl mb-8 border border-white/5 bg-white/5">
                <img
                  src={project.image}
                  alt={project.title}
                ...
                <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  ...
                  <div className="w-12 h-12 rounded-full bg-white text-bg flex items-center justify-center">
